...
public class BTSettingSubPanel extends JPanel {
    ...
    public static final String DEFAULT_UUID_TX = "6e400002-b5a3-f393-e0a9-e50e24dcca9e";
    public static final String DEFAULT_UUID_RX = "6e400003-b5a3-f393-e0a9-e50e24dcca9e";
